...
<div class="<?php echo esc_attr( $pixwell_classname ); ?>">
	<a href="<?php echo esc_url( $pixwell_url ); ?>" class="logo" title="<?php echo esc_attr( $pixwell_logo_name ) ?>">
		<?php if ( empty( $pixwell_logo_retina['url'] ) ) : ?>
			<img decoding="async" class="logo-default" <?php if ( ! empty( $pixwell_logo_dark['url'] ) ) { echo ' data-mode="default" '; } ?> height="<?php echo esc_attr( $pixwell_height ); ?>" width="<?php echo esc_attr( $pixwell_width ); ?>" src="<?php echo esc_url( $pixwell_logo['url'] ) ?>" alt="<?php echo esc_attr( $pixwell_logo_name ); ?>">
			<?php if ( ! empty( $pixwell_logo_dark['url'] ) ) : ?>
				<img decoding="async" class="logo-default logo-dark" data-mode="dark" height="<?php echo esc_attr( $pixwell_height ); ?>" width="<?php echo esc_attr( $pixwell_width ); ?>" src="<?php echo esc_url( $pixwell_logo_dark['url'] ) ?>" alt="<?php echo esc_attr( $pixwell_logo_name ); ?>">
			<?php endif; ?>
		<?php else: ?>
			<img decoding="async" class="logo-default logo-retina" <?php if ( ! empty( $pixwell_logo_retina_dark['url'] ) ) { echo ' data-mode="default" '; } ?> height="<?php echo esc_attr( $pixwell_height ); ?>" width="<?php echo esc_attr( $pixwell_width ); ?>" src="<?php echo esc_url( $pixwell_logo['url'] ) ?>" srcset="<?php echo esc_url( $pixwell_logo['url'] ) ?> 1x, <?php echo esc_url( $pixwell_logo_retina['url'] ); ?> 2x" alt="<?php echo esc_attr( $pixwell_logo_name ); ?>">
