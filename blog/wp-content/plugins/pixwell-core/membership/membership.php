...
if ( ! class_exists( 'Pixwell_Membership' ) ) {
	class Pixwell_Membership {
		...
		public function __construct() {
			...
			add_filter( 'Pixwell_entry_title_classes', [ $this, 'add_classes' ], 10, 2 );
		}
		...
		public function restrict_box( $error_msg ) {
			...
			$restrict_title = pixwell_get_option( 'restrict_title' );
			$restrict_desc  = pixwell_get_option( 'restrict_desc' );
			$join_us_label  = pixwell_get_option( 'join_us_label' );
			$login_label    = pixwell_get_option( 'login_label' );
			$login_desc     = pixwell_get_option( 'login_desc' );

			$output = '';
			$output .= '<div class="restrict-box"><div class="restrict-box-inner">';

			$output .= '<h2 class="restrict-title">' . pixwell_strip_tags( $restrict_title ) . '</h2>';
			$output .= '<p class="restrict-desc">' . pixwell_strip_tags( $restrict_desc ) . '</p>';
			...
			$output .= '<span class="restrict-login-description">' . pixwell_strip_tags( $login_desc ) . '</span>';
			$output .= '<a class="restrict-login-link" href="' . $login_url . '">' . pixwell_strip_tags( $login_label ) . '</a>';
			$output .= '</div>';
		...
		public function restrict_level_box( $error_msg ) {
			...
			$restrict_title = pixwell_get_option( 'restrict_level_title' );
			$restrict_desc  = pixwell_get_option( 'restrict_level_desc' );
			$join_us_label  = pixwell_get_option( 'join_us_label' );
		...
		public function restrict_renewal_box( $error_msg ) {
			...
			$restrict_title = pixwell_get_option( 'restrict_renewal_title' );
			$restrict_desc  = pixwell_get_option( 'restrict_renewal_desc' );
			$renewal_label  = pixwell_get_option( 'renewal_label' );
