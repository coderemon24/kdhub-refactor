				...
				<div class="w-banner-content">
					<div class="content-inner">
						<?php if ( ! empty( $instance['title'] ) ) : ?>
							<span class="w-banner-title h2"><?php pixwell_render_inline_html( $instance['title'] ); ?></span>
						<?php endif;
						if ( ! empty( $instance['description'] ) ) : ?>
							<span class="w-banner-desc element-desc"><?php pixwell_render_inline_html( $instance['description'] ); ?></span>
						<?php endif;
