	...
	class pixwell_widget_social_icon extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			if ( ! empty( $instance['content'] ) ) : ?>
				<div class="<?php echo esc_attr( $class_name ); ?>">
					<?php echo html_entity_decode( $instance['content'] ); ?>
				</div>
			<?php endif; ?>
		...
		function form( $instance ) {
			...
			<p>
				...
				<textarea rows="10" cols="50" id="<?php echo esc_attr( $this->get_field_id( 'content' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'content' ) ); ?>" class="widefat"><?php echo $instance['content'] ; ?></textarea>
			</p>
			<p>
				...
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>">
					<option value="1" <?php if ( ! empty( $instance['style'] ) && $instance['style'] == '1' ) {
						echo "selected=\"selected\"";
					} else {
						echo "";
					} ?>><?php esc_attr_e( 'Left', 'pixwell-core' ); ?></option>
					<option value="2" <?php if ( ! empty( $instance['style'] ) && $instance['style'] == '2' ) {
						echo "selected=\"selected\"";
					} else {
						echo "";
					} ?>><?php esc_attr_e( 'Center', 'pixwell-core' ); ?></option>
				</select>
			</p>
			<p>
				...
				<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'data_social' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'data_social' ) ); ?>">
					<option value="1" <?php if ( ! empty( $instance['data_social'] ) && $instance['data_social'] == '1' ) {
						echo "selected=\"selected\"";
					} else {
						echo "";
					} ?>><?php esc_attr_e( 'Theme Options', 'pixwell-core' ); ?></option>
					<option value="2" <?php if ( ! empty( $instance['data_social'] ) && $instance['data_social'] == '2' ) {
						echo "selected=\"selected\"";
					} else {
						echo "";
					} ?>><?php esc_attr_e( 'Use Custom', 'pixwell-core' ); ?></option>
				</select>
			</p>
			...
			<p>
				...
				<input class="widefat" type="checkbox" id="<?php echo esc_attr( $this->get_field_id( 'new_tab' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'new_tab' ) ); ?>" value="true" <?php if ( ! empty( $instance['new_tab'] ) ) {
			...
			<p>
				...
				<input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'social_facebook' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'social_facebook' ) ); ?>" value="<?php if ( ! empty( $instance['social_facebook'] ) ) {
					echo esc_attr( $instance['social_facebook'] );
				} ?>"/>
			</p>
			<p>
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'social_telegram' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'social_telegram' ) ); ?>" value="<?php echo esc_html( $instance['social_telegram'] ); ?>"/>
			</p>
			<p>
