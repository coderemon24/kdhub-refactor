	...
	class pixwell_widget_newsletter extends WP_Widget {
		...
		function form( $instance ) {
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'privacy' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'privacy' ) ); ?>" value="<?php echo esc_html( $instance['privacy'] ); ?>"/>
			</p>
			<p>
