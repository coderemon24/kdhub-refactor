...
if ( ! class_exists( 'pixwell_widget_sb_instagram' ) ) :
	class pixwell_widget_sb_instagram extends WP_Widget {
			...
			<div class="instagram-grid layout-default">
				<?php if ( ! empty( $data_images['error'] ) ) :
					...
					<div class="grid-footer">
						<a href="<?php echo esc_url( $instance['footer_url'] ); ?>" target="_blank" rel="noopener nofollow"><?php pixwell_render_inline_html( $instance['footer_intro'] ) ?></a>
					</div>
				<?php endif;
				endif; ?>
			</div>
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['footer_intro']    = pixwell_strip_tags( $new_instance['footer_intro'] );
		...
		function form( $instance ) {
			...
			<p>
				...
				<em><?php esc_html_e( 'Input your Instagram username or tags (ie: #technology). Maximum is 12 images.', 'pixwell-core' ); ?></em>
			</p>
			...
			<p>
				...
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'footer_intro' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'footer_intro' ) ); ?>" type="text" value="<?php echo pixwell_strip_tags( $instance['footer_intro'] ); ?>"/>
			</p>
			<p>
