	...
	class pixwell_widget_header_strip extends WP_Widget {
				...
				<div class="content-inner">
					...
					if ( ! empty( $instance['url'] ) ) : ?>
						<div class="headerstrip-btn">
							<a href="<?php echo esc_url( $instance['url'] ) ?>" target="_blank" rel="noopener nofollow" <?php echo do_shortcode( $btn_style ); ?>><?php echo esc_html( $instance['submit'] ) ?></a>
						</div>
					<?php endif; ?>
				</div>
				<a class="headerstrip-submit" href="#" aria-label="<?php esc_attr_e('Close', 'pixwell-core'); ?>"><i class="btn-close"></i></a>
			</div>
		...
		function form( $instance ) {
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'bg_color' ) ); ?>" value="<?php echo esc_html( $instance['bg_color'] ); ?>"/>
			</p>
			<em><?php esc_html_e('Input the hex value ie: #333333', 'pixwell-core')?></em>
			<p>
			...
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'url' ) ); ?>" value="<?php echo esc_html( $instance['url'] ); ?>"/>
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'submit' ) ); ?>"><strong><?php esc_html_e( 'Button Text', 'pixwell-core' ) ?></strong></label>
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'submit' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'submit' ) ); ?>" value="<?php echo esc_html( $instance['submit'] ); ?>"/>
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'btn_color' ) ); ?>"><strong><?php esc_html_e( 'Button Color', 'pixwell-core' ) ?></strong></label>
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'btn_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'btn_color' ) ); ?>" value="<?php echo esc_html( $instance['btn_color'] ); ?>"/>
			</p>
			<p>
				...
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'btn_bg_color' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'btn_bg_color' ) ); ?>" value="<?php echo esc_html( $instance['btn_bg_color'] ); ?>"/>
			</p>
			<p>
