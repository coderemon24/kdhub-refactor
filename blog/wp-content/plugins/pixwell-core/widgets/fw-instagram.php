	...
	class pixwell_widget_fw_instagram extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array(
				...
				'description' => esc_attr__( 'Display Instagram images in a grid layout in the FullWidth section.', 'pixwell-core' )
			);
			...
			<div class="<?php echo join( ' ', $classes ); ?>">
				<?php if ( ! empty( $instance['header_intro'] ) && ! $flag ) : ?>
					<div class="grid-header">
						<a href="<?php echo esc_url( $instance['url'] ); ?>" target="_blank"><?php pixwell_render_inline_html( $instance['header_intro'] ) ?></a>
					</div>
				<?php endif;
                                ...
                                if ( true == $flag && ! empty( $instance['header_intro'] ) ) : ?>
                                    <div class="grid-el <?php echo esc_attr( $instance['total_cols'] ) ?>">
                                        <div class="instagram-box box-intro">
                                            ...
                                            <div class="box-content"><i class="rbi rbi-instagram"></i><?php pixwell_render_inline_html( $instance['header_intro'] ); ?></div>
                                        </div>
                                    </div>
									<?php $flag = false;
								endif; ?>
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['header_intro']    = pixwell_strip_tags( $new_instance['header_intro'] );
		...
		function form( $instance ) {
			...
			<p>
				...
				<textarea rows="10" cols="50" id="<?php echo esc_attr($this->get_field_id( 'header_intro' )); ?>" name="<?php echo esc_attr($this->get_field_name('header_intro')); ?>" class="widefat"><?php echo $instance['header_intro']; ?></textarea>
			</p>
			<p>
			...
			<p><em><?php esc_html_e('Below options will only apply to default grid layout.', 'pixwell-core'); ?></em></p>
			<p>
