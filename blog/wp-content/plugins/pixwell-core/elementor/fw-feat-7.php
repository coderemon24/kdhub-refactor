...
use function pixwell_rbc_fw_feat_7;
...
class Fw_Feat_7 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Pixwell - LifeStyle Carousel (Boxed)', 'pixwell-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .p-overlay-6.p-overlay .content-overlay:before' => 'opacity: {{SIZE}};',
				],
			]
		);
		$this->add_responsive_control(
			'display_ratio', [
				...
				'selectors'   => [
					'{{WRAPPER}} .rb-iwrap.pc-110' => 'padding-bottom: {{VALUE}}%',
				],
			]
		);
		$this->end_controls_section();
