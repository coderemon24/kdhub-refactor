...
use function pixwell_rbc_fw_feat_13;
...
class Fw_Feat_13 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Pixwell - Gadgets Slider (Boxed)', 'pixwell-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'.is-fmask {{WRAPPER}} .p-overlay.f-gradient .rb-iwrap:after,{{WRAPPER}} .p-overlay-9 .p-feat:after' => 'opacity: {{SIZE}};',
				],
			]
		);
		$this->add_responsive_control(
			'display_ratio', [
				...
				'selectors'   => [
					'{{WRAPPER}} .p-overlay-9 .rb-iwrap' => 'padding-bottom: {{VALUE}}%',
				],
			]
		);
		$this->end_controls_section();
