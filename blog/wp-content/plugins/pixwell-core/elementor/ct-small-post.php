...
use function pixwell_rbc_ct_small_post;

defined( 'ABSPATH' ) || exit;

class Ct_small_post extends Widget_Base {

	public function get_name() {

		return 'ct-small-list';
	}

	public function get_title() {

		return esc_html__( 'Pixwell - Content Small List', 'pixwell-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_l_layout', [
				'label' => esc_html__( 'List Layout', 'pixwell-core' ),
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'List Layout', 'pixwell-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => Options::smal_list_style(),
				'default' => '1',
			]
		);
	...
	protected function render() {
		...
		if ( function_exists( 'pixwell_rbc_ct_small_post' ) ) {
			...
			echo pixwell_rbc_ct_small_post( $settings );
		}
	}
}
