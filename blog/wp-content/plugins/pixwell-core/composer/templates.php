	...
	<div id="rbc-editor" class="rbc-editor-wrap is-hidden">
		<div class="rbc-editor-header">
			<div class="rbc-editor-header-inner">
				<h3 class="rbc-editor-heading">
					<i class="dashicons dashicons-art"></i><?php esc_html_e( 'Ruby Composer', 'rbc' ); ?></h3>
				<div class="rbc-template-panel-outer">
					<a href="#" id="rbc-main-template-btn" title="templates"><i class="dashicons dashicons-download"></i><?php esc_html_e( 'Templates', 'rbc' ); ?>
					</a>
					<div class="rbc-template-panel">
						<a href="#" id="rbc-template-save-btn" title="save template"><i class="dashicons dashicons-cloud"></i><?php esc_html_e( 'Save Content as Template', 'rbc' ); ?>
						</a>
		...
		<div class="rbc-section-header">
			...
			<div class="rbc-panel-block clearfix">
				...
				<div class="rbc-panel-block-header">
					<h3 class="rbc-block-list-title is-nav-active rbc-panel-nav-target" data-target="list">
						<i class="dashicons dashicons-archive"></i><?php esc_html_e( 'Blocks', 'rbc' ); ?></h3>
					<h3 class="rbc-section-settings-title rbc-panel-nav-target" data-target="settings">
						<i class="dashicons dashicons-admin-generic"></i><?php esc_html_e( 'Section Settings', 'rbc' ); ?>
					</h3>
				</div>
		...
		<div class="rbc-section-header">
			...
			<div class="rbc-panel-block clearfix">
				...
				<div class="rbc-panel-block-header">
					<h3 class="rbc-block-list-title is-nav-active rbc-panel-nav-target" data-target="list">
						<i class="dashicons dashicons-archive"></i><?php esc_html_e( 'Blocks', 'rbc' ); ?></h3>
					<h3 class="rbc-block-sidebar-title rbc-panel-nav-target" data-target="sidebar">
						<i class="dashicons dashicons-align-left"></i><?php esc_html_e( 'Sidebar Settings', 'rbc' ); ?>
					</h3>
					<h3 class="rbc-section-settings-title rbc-panel-nav-target" data-target="settings">
						<i class="dashicons dashicons-admin-generic"></i><?php esc_html_e( 'Section Settings', 'rbc' ); ?>
					</h3>
...
<script type="text/html" id="tmpl-rbc-input-order">
	<select class="rbc-field rbc-field-select rbc-field-order" name="rbc_option[{{{data.uuid}}}][{{{data.name}}}]">
		...
		<?php $data = [
			...
			'popular'                 => esc_html__( 'Popular (by Post Views)', 'rbc' ),
			'popular_3d'              => esc_html__( 'Popular Published Last 3 Days', 'rbc' ),
			'popular_w'               => esc_html__( 'Popular Published Last 7 Days', 'rbc' ),
			'popular_m'               => esc_html__( 'Popular Published Last 30 Days', 'rbc' ),
			'popular_3m'              => esc_html__( 'Popular Published Last 3 Months', 'rbc' ),
			'popular_6m'              => esc_html__( 'Popular Published Last 6 Months', 'rbc' ),
			'top_review'              => esc_html__( 'Top Review', 'rbc' ),
			'top_review_3d'           => esc_html__( 'Top Review Published Last 3 Days', 'rbc' ),
			'top_review_w'            => esc_html__( 'Top Review Published Last 7 Days', 'rbc' ),
			'top_review_m'            => esc_html__( 'Top Review Published Last 30 Days', 'rbc' ),
			'top_review_3m'           => esc_html__( 'Top Review Published Last 3 Months', 'rbc' ),
			'top_review_6m'           => esc_html__( 'Top Review Published Last 6 Months', 'rbc' ),
			'top_review_y'            => esc_html__( 'Top Review Published Last Year', 'rbc' ),
			'last_review'             => esc_html__( 'Latest Review', 'rbc' ),
			'sponsored'               => esc_html__( 'Latest Sponsored', 'rbc' ),
			'post_type'               => esc_html__( 'Post Type', 'rbc' ),
			'rand'                    => esc_html__( 'Random', 'rbc' ),
			'rand_w'                  => esc_html__( 'Random last 7 Days', 'rbc' ),
			'rand_m'                  => esc_html__( 'Random last 30 Days', 'rbc' ),
			'rand_3m'                 => esc_html__( 'Random last 3 Months', 'rbc' ),
			'rand_6m'                 => esc_html__( 'Random last 6 Months', 'rbc' ),
			'rand_y'                  => esc_html__( 'Random last Last Year', 'rbc' ),
