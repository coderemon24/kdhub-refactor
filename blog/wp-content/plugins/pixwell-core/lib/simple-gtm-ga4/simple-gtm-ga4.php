...
if ( ! class_exists( 'Ruby_GTM_Integration', false ) ) {
	...
	class Ruby_GTM_Integration {
		...
		function enqueue_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'simple-gtm-ga4-style', SIMPLE_GTM_GA4_PLUGIN_URL . 'assets/css/simple-gtm-ga4.css', '', SIMPLE_GTM_GA4_VERSION );
			...
			wp_localize_script( 'simple-gtm-ga4-script', 'simpleGTMParams', [ 'ajaxurl' => admin_url( 'admin-ajax.php' ) ] );
		}
