...
<div>
    ...
    @else
        <main id="main">
                ...
                @php
                    $contens = App\Models\Admin\SectionContent::where('section_id', $sections[0]->id)->get();
                @endphp
                ...
                <section id="more-adds-info">
                    <div class="container text-center">
                        <h2 class="mb-4 fw-bold">{{ $sections[1]->title }}</h2>
                        <p class="mb-5" style="color: #737373;">
                            {!! $sections[1]->description !!}
                        </p>
                        <div class="row">
                            @php    
                                $contents = App\Models\Admin\SectionContent::where('section_id', $sections[1]->id)->get();
                            @endphp
                ...
                @php
                    $contents = App\Models\Admin\SectionContent::where('section_id', $sections[4]->id)->get();
                @endphp
                    ...
                    <!-- End Clients Section -->
                @php
                    $contents = App\Models\Admin\SectionContent::where('section_id', $sections[5]->id)->get();
                @endphp
                    @foreach($contents as $content)
                        <div class="row">
                            <div class="col-md-6">
                ...
                <section id="case-studies">
                    <div class="container">
                        ...
                        <div class="row mt-3 pt-5 gy-4">
                            @php
                                $contents = App\Models\Admin\SectionContent::where('section_id', $sections[6]->id)
                ...
                <section id="web-services">
                    <div class="container">
                        <div class="google-ads-services mt-3 p-5 mb-3" style="background:#f5f5f5; border-left: 20px solid #f2aa4b;">
                            ...
                            @php
                                $contents = App\Models\Admin\SectionContent::where('section_id', $sections[7]->id)
                                ->where('status','active')->get();
                            @endphp
                            @foreach($contents as $content)
                            <div class="row">
                ...
                <section id="google-ads-works">
                    ...
                    {{-- <div class="how-it-works mt-5 pt-5">
                        <h2 class="fw-bold mb-3" style="color: #4d4d4d;">
                            {{$sections[8]->title}}
                        </h2>
                    ...
                    <div class="how-much-it-cost">
                        @php
                            $contents = App\Models\Admin\SectionContent::where('section_id', $sections[8]->id)
                            ->where('status','active')->get();
                        @endphp
                       @foreach($contents as $content)  
                      ...
                      @php
                        $contents = App\Models\Admin\SectionContent::where('section_id', $sections[9]->id)
                        ->where('status','active')->get();
                      @endphp  
                      @foreach($contents as $content)  
                      ...
                      @endforeach
                        ...
                        <div class="mt-2 pt-5" style="border-bottom: 3px solid #ededed;"></div>
                      @php
                        $contents = App\Models\Admin\SectionContent::where('section_id', $sections[10]->id)
                        ->where('status','active')->get();
                      @endphp    
                      @foreach($contents as $content)  
                        <h2 class="fw-bold mb-3 mt-4" style="color: #4d4d4d;">
                    ...
                    <div class="accordion-body">
                        ...
                        @php
                            $contents = App\Models\Admin\SectionContent::where('section_id', $sections[11]->id)
                            ->where('status','active')->get();
                        @endphp
                        @foreach($contents as $content)
                            <div class="container">
