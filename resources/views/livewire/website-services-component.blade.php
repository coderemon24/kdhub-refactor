...
<div>
    ...
    @else
        <main id="main">
                    ...
                    @foreach($contents->where('section_id', $sections[0]->id)->where('status', 'active') as $content)
                    ...
                    <!-- We're WordPress Website Design Experts section  -->
                        ...
                        <div class="container mt-5">
                            @foreach($contents->where('section_id', $sections[4]->id)->where('status','active') as $content)
                            <div class="row">
                                <div class="col-md-6">
