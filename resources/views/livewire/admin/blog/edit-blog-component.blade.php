            ...
            <div class="card shadow mb-4">
                <div class="card-header bg-primary py-3">
                    <div class="d-sm-flex justify-content-between">
                        <h6 class="m-0 font-weight-bold text-light mt-3">Edit Blog</h6>
                    </div>
                </div>
                <div class="card-body">
                ...
                <form wire:submit.prevent='updateBlog'>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="editor" wire:model.defer="description" class="form-control @error('description') is-invalid @enderror mb-2" cols="30" rows="5">{{$description}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        @else
                            <img width="100" src="{{asset('assets/image/Blog/'.$old_image)}}" alt="">
                        @endif
                    </div>
